  ...
  up: (queryInterface, Sequelize) => {
    ...
    */
      return queryInterface.bulkInsert('Listings', [
        {userId: 1, name: 'Salesforce Tower', address:'415 Mission St', city: 'San Francisco', state: 'CA', country: 'USA', price: 25,
         ...
         {userId: 1, name: 'Bayshore Business Center', address:'1485 Bay Shore Blvd', city: 'San Francisco', state: 'CA', country: 'USA', price: 15,
         ...
         {userId: 1, name: '825 Third Ave', address:'845 Third Ave', city: 'New York', state: 'NY', country: 'USA', price: 32,
         ...
         {userId: 2, name: 'Masonic Hall', address:'71 W 23rd St', city: 'New York', state: 'NY', country: 'USA', price: 38,
         ...
         {userId: 2, name: '1245 Broadway', address:'1245 Broadway', city: 'New York', state: 'NY', country: 'USA', price: 10,
